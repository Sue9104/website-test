<template>
  <div id="overviewListMain" class="clearfix">
    <el-breadcrumb separator-class="el-icon-arrow-right">
      <el-breadcrumb-item>Overview List</el-breadcrumb-item>
    </el-breadcrumb>
    ...
    <div class="showUserInfo">
      <el-table ref="ProjectTable" :data="overviewListTable" v-loading="loading" stripe border style="width: 100%" @row-dblclick="rowDblClick">
        ...
        <el-table-column prop="task Nums" label="Untranslate" align="center" v-if="$route.path==='/t_overviewlist'">
          <template slot-scope="scope">
        ...
        <el-table-column prop="task Nums" label="Unreview" align="center" v-if="$route.path==='/a_overviewlist'">
          <template slot-scope="scope">
